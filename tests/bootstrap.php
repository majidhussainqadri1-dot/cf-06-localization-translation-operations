...
if (! defined('SABRI_SLTO_CONTRACT_VERSION')) {
    define('SABRI_SLTO_CONTRACT_VERSION', '1.2.0');
}
...
require_once $root . '/src/Domain/Translation/MessageFormatValidator.php';
...
require_once $root . '/src/Domain/Bundle/BundleFreshnessGuard.php';
