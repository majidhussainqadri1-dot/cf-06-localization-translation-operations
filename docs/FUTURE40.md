...
- `FutureCapabilitiesFacade` itself enforces canonical byte, node-count and nesting-depth limits before recursive guards, so internal application consumers cannot bypass REST-layer structural limits.
